...
func TestSIPrefix(t *testing.T) {
	...
	cases := [...]struct {
		...
		{zero, "0"}, {-zero, "-0"},
		{1e-39 / 3., "3.333e-10q"}, {1e-38 / 3., "3.333e-09q"},
		{1e-37 / 3., "3.333e-08q"}, {1e-36 / 3., "3.333e-07q"},
		{1e-35 / 3., "3.333e-06q"}, {1e-34 / 3., "3.333e-05q"},
		{1e-33 / 3., "0.0003333q"}, {1e-32 / 3., "0.003333q"},
		{1e-31 / 3., "0.03333q"}, {1e-30 / 3., "0.3333q"},
		{1e-29 / 3., "3.333q"}, {1e-28 / 3., "33.33q"},
		{1e-27 / 3., "333.3q"}, {1e-26 / 3., "3.333r"},
		{1e-25 / 3., "33.33r"}, {1e-24 / 3., "333.3r"},
		{1e-23 / 3., "3.333y"}, {1e-22 / 3., "33.33y"},
		{1e-21 / 3., "333.3y"}, {1e-20 / 3., "3.333z"},
		{1e-19 / 3., "33.33z"}, {1e-18 / 3., "333.3z"},
		{1e-17 / 3., "3.333a"}, {1e-16 / 3., "33.33a"},
		{1e-15 / 3., "333.3a"}, {1e-14 / 3., "3.333f"},
		{1e-13 / 3., "33.33f"}, {1e-12 / 3., "333.3f"},
		{1e-11 / 3., "3.333p"}, {1e-10 / 3., "33.33p"},
		{1e-09 / 3., "333.3p"}, {1e-08 / 3., "3.333n"},
		{1e-07 / 3., "33.33n"}, {1e-06 / 3., "333.3n"},
		{1e-05 / 3., "3.333μ"}, {1e-04 / 3., "33.33μ"},
		{1e-03 / 3., "333.3μ"}, {1e-02 / 3., "3.333m"},
		{1e-01 / 3., "33.33m"}, {1e+00 / 3., "333.3m"},
		{1e+01 / 3., "3.333"}, {1e+02 / 3., "33.33"},
		{1e+03 / 3., "333.3"}, {1e+04 / 3., "3.333k"},
		{1e+05 / 3., "33.33k"}, {1e+06 / 3., "333.3k"},
		{1e+07 / 3., "3.333M"}, {1e+08 / 3., "33.33M"},
		{1e+09 / 3., "333.3M"}, {1e+10 / 3., "3.333G"},
		{1e+11 / 3., "33.33G"}, {1e+12 / 3., "333.3G"},
		{1e+13 / 3., "3.333T"}, {1e+14 / 3., "33.33T"},
		{1e+15 / 3., "333.3T"}, {1e+16 / 3., "3.333P"},
		{1e+17 / 3., "33.33P"}, {1e+18 / 3., "333.3P"},
		{1e+19 / 3., "3.333E"}, {1e+20 / 3., "33.33E"},
		{1e+21 / 3., "333.3E"}, {1e+22 / 3., "3.333Z"},
		{1e+23 / 3., "33.33Z"}, {1e+24 / 3., "333.3Z"},
		{1e+25 / 3., "3.333Y"}, {1e+26 / 3., "33.33Y"},
		{1e+27 / 3., "333.3Y"}, {1e+28 / 3., "3.333R"},
		{1e+29 / 3., "33.33R"}, {1e+30 / 3., "333.3R"},
		{1e+31 / 3., "3.333Q"}, {1e+32 / 3., "33.33Q"},
		{1e+33 / 3., "333.3Q"}, {1e+34 / 3., "3333Q"},
		{1e+35 / 3., "3.333e+04Q"}, {1e+36 / 3., "3.333e+05Q"},
		{1e+37 / 3., "3.333e+06Q"}, {1e+38 / 3., "3.333e+07Q"},
	}
	for _, c := range cases {
